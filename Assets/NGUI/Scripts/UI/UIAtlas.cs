...
public class UIAtlas : MonoBehaviour
{
    ...
    [HideInInspector][SerializeField] Material materialGray;   // 김홍열 추가
    [HideInInspector][SerializeField] Material materialBright; // 김홍열 추가
	...
	public Material spriteMaterial
	{
		...
		set
		{
			...
			{
                materialGray = null;   // 김홍열 추가
                materialBright = null; // 김홍열 추가
                if (material == null)
				{
					mPMA = 0;
					material = value;
